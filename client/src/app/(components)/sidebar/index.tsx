  ...
  return (
    <div className={sidebarClassNames}>
     <div className='flex h-[100%] w-full flex-col justify-start'>
            ...
            {/*Team */}
            <div className='flex items-center gap-5 border-y-[1.5px] border-gray-300 px-8 py-4 dark:border-gray-700'>
                ...
                <div className='mt-1 flex items-start gap-2'>
                    <LockIcon className='mt-[o.1rem] h-3 w-3 text-gray-500 dark:text-gray-400'/>
                <p className='text-xs text-gray-500'>Private</p></div>
                </div>
            </div>
